...
<html>
  ...
  <body>
    ...
    <div style="background-color:#b3e6ff;">
        <h1 align="center" style=" margin-top: 1px; color:#003300;">All Quiz</h1>
        <table style=" border-collapse: collapse; width: 1450px; color: #588c7e; font-family: monospace;font-size: 25px; text-align: left;"align="center" >
             <tr style="background-color: #f2f2f2;" >
              ...
              <th style="background-color: #588c7e; color: white;">Question</th>
            ...
            $conn = mysqli_connect("localhost", "root", "", "programming");
              ...
              $sql = "SELECT username, language, question FROM quiz";
              ...
              while ($user=mysqli_fetch_array($result)) {
                ...
                <tr>
                  ...
                  <td><a href="answer.php?user_id=<?php echo $user['id']?>">Answer</a><br/>
