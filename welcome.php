		...
		<div class="container">
			<div class="row">
				<div class="col-md-4">
					...
					<p>Give us a look to your problem.</p>
				</div>
    			<div class="col-md-4">
    				<div class="circle" style="background-color: #9E9D24;"></div>
    				<h2><a href="problem.php">Problem</a></h2>
    				<p>Set or take a look to programming problem.</p>
    			</div>
    			<div class="col-md-4">
    				<div class="circle" style="background-color: #9E9D24;"></div>
    				<h2><a href="quiz.php">Quiz</a></h2>
    				<p>Set or Answer quiz to test your knowledge.</p>
    			</div> 
			</div>
		</div>
	</section>
