...
if (isset($_POST) & !empty($_POST)){
    ...
    $query="INSERT INTO quiz(question,language,username,answer)VALUES('$question','$language','$username','$answer')";
    ...
    <div>
        ...
        <div  class="form">
            <form method="POST" name="vform" onsubmit="return Validate()" > 
                ...
                <input type="text" id="username" name="username" placeholder="Username" style="width: 350px;" required/> 

                <p class="contact"><label for="language">Enter Language name</label></p> 
                <input type="text" id="language" name="language" placeholder="Language" style="width: 350px;" required/> 
                       
                <p class="contact"><label for="question">Write your question</label></p> 
                <textarea type="text" id="question" name="question" placeholder="Details of Question" style="width: 350px;height: 200px;" required/>
                </textarea> 

                <p class="contact" style="margin-top: 20px;"><label for="answer">Enter Answer</label></p> 
                <input type="text" id="answer" name="answer" placeholder="Enter Answer" style="width: 350px;" required/> 
