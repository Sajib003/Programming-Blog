...
<html>
 ...
 <?php
            ...
            $query = $mysqli->query("SELECT * FROM post WHERE post_id='$id' LIMIT 0,1");
    ...
    <div>
        <h3 style="margin-left: 635px;margin-bottom: 35px;">Comment</h3> 
        <div  class="form">
            <form method="POST" name="vform" onsubmit="return Validate()" > 
                       
                <p class="contact"><label for="details">Write your comment</label></p> 
