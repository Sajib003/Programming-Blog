...
if (isset($_POST) & !empty($_POST)){
    ...
    $query="INSERT INTO post(username,title,language,details)VALUES('$username','$title','$language','$details')";
    ...
    <div>
        ...
        <div  class="form">
            <form method="POST" name="vform" onsubmit="return Validate()" > 
                ...
                <input type="text" id="title" name="title" placeholder="Title of your post" style="width: 350px;" required/> 
                ...
                <textarea type="text" id="details" name="details" placeholder="Description of your post" style="width: 350px;height: 200px;" required/>
                </textarea> 
